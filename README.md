...
First implementation will be the forthcoming [triciti.es](http://triciti.es), hoping to launch at [TriConf](http://triconf.com) as a successor to [WeCreate TC](http://wecreate.tc).
